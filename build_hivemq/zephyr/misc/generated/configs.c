...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MQTT_SAMPLE_TRANSPORT_PASSWORD, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MQTT_SAMPLE_TRANSPORT_USERNAME, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MQTT_HELPER_SEC_TAG, 955);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MQTT_KEEPALIVE, 30);
