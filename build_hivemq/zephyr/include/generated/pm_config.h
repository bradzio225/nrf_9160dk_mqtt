...
#define PM_NUM 4
#define PM_ALL_BY_SIZE "otp nrf_modem_lib_ctrl nrf_modem_lib_rx nrf_modem_lib_tx nrf_modem_lib_trace tfm tfm_sram sram_secure tfm_secure nrf_modem_lib_sram sram_primary sram_nonsecure app tfm_nonsecure"
